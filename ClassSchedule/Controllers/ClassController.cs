...
namespace ClassSchedule.Controllers
{
    public class ClassController : Controller
    {
        ...
        public ClassController(IClassScheduleUnitOfWork classScheduleUnitOfWork, IHttpContextAccessor httpContextAccessor)
        {
        ...
        private RedirectToActionResult GoToClasses()
        {
            ...
            if (_httpContextAccessor.HttpContext.Session.GetInt32("dayid").HasValue)
                return RedirectToAction("Index", "Home", new { id = _httpContextAccessor.HttpContext.Session.GetInt32("dayid") });
            else
                return RedirectToAction("Index", "Home");
        }
    }
